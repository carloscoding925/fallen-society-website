        ...
        <div>
            <div className="flex flex-row place-content-center w-full text-white">
                <div className="w-full pt-4">
                    ...
                    <div className="flex flex-row place-content-center">
                        <div className="flex flex-col w-1/2 space-y-6 justify-center items-center">
                            <a href="https://www.unrealengine.com/en-US/blog/unreal-engine-5-5-is-now-available" target="_blank" rel="noopener noreferrer" className="font-bold text-lg hover:text-blue-400">Unreal Engine 5.5 Release - News, Features, and Updates (Click me)</a>
                        </div>
                    </div>
                    <div className="flex flex-row place-content-center w-full pt-6 pb-8">
                        <h1 className="text-2xl font-custom text-white">
                            Related Articles, Journals, and Documentation
                        </h1>
                    </div>
                    <div className="flex flex-row place-content-center">
                        <div className="flex flex-col w-1/2 space-y-6 justify-center items-center">
                            <a href="https://dev.epicgames.com/documentation/en-us/unreal-engine/unreal-engine-5-5-documentation" target="_blank" rel="noopener noreferrer" className="font-bold text-lg hover:text-blue-400">Unreal Engine Documentation (Click me)</a>
                            <a href="https://digra.org/" target="_blank" rel="noopener noreferrer" className="font-bold text-lg hover:text-blue-400">Digital Games Research Association (Click me)</a>
                            <a href="https://users.cs.northwestern.edu/~hunicke/MDA.pdf" target="_blank" rel="noopener noreferrer" className="font-bold text-lg hover:text-blue-400">A Formal Approach to Game Design & Game Research (Click me)</a>
                        </div>
                    </div>
                </div>
            </div>
